...
import glorifyInstantVideo from "@/assets/Glorify Instant.mp4";
import roseMilkVideo from "@/assets/Rajamundry Vari Rose Milk Franchise -_ Bandar Badam Milk Demo.mp4";
import uberInternshipVideo from "@/assets/Uber Internship edit by Kiran.mp4";
...
const WorkSection = () => {
  ...
  const showreels = [
    ...
    },
    {
      ...
      src: uberInternshipVideo,
    },
    {
      title: "Glorify Instant",
      src: glorifyInstantVideo,
    },
  ];
